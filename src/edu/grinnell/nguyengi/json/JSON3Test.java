...
public class JSON3Test
{
  ...
  /**
   * Keeps some sample HashMap (JSON3 object) values
   */
   ...
   * to the stored ArrayList and a String to the JSON3 String
   * 
   * @param arr
   ...
   * adding both an element to the stored HashMap and a String to the JSON3
   * String
   * 
   * @param obj
  ...
  /**
   * Compares the Pair's stored object against the parsed result of the JSON3
   * class
   * 
   * @param pr
   *          a Pair
  ...
  boolean testPair(Pair pr)
    throws Exception
  {
    return pr.parsed.equals(JSON3.parse(pr.unparsed));
  } // testPair(Pair)

  /**
   * Helper class to help keep track of and check a JSON3 String and its
   * corresponding JSON3 object
   * 
   * @author Giang
   */
  ...
  class Pair<K>
  {
    ...
    /**
     * The JSON3 String that will be parsed to check against the object
     */
    String unparsed;

    /**
     * Keeps track of a stored JSON3 object
     */
    K parsed;
